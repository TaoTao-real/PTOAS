...
const llvm::DenseMap<std::pair<PipelineType, PipelineType>, uint64_t>
    SyncEventIdAllocation::reservedEventIdNum = {
        ...
        {{PipelineType::PIPE_MTE2, PipelineType::PIPE_S}, 1},
        {{PipelineType::PIPE_S, PipelineType::PIPE_MTE2}, 1},
        {{PipelineType::PIPE_MTE3, PipelineType::PIPE_S}, 1},
        {{PipelineType::PIPE_S, PipelineType::PIPE_MTE3}, 1},
};
