...
extern "C" __global__ AICORE void TROWEXPANDDIV_f32_64x64_vmi_rows(__gm__ float *src0, __gm__ float *src1, __gm__ float *dst);
...
void LaunchTROWEXPANDDIV_f32_64x64_vmi_rows(float *src0, float *src1, float *dst, void *stream) {
    TROWEXPANDDIV_f32_64x64_vmi_rows<<<1, nullptr, stream>>>((__gm__ float *)src0, (__gm__ float *)src1, (__gm__ float *)dst);
}
